...
-- Users (Pass: password123 -> BCrypt: $2a$10$KDmWsbODf8lRtE8MRdsmu.krGlvaWjTtdvHjD8nE3o/pjLAMeETYu)
INSERT INTO users (id, name, phone, email, password_hash, device_fingerprint, status) VALUES
(1, 'Super Admin User', '+1000000000', 'superadmin@queueless.com', '$2a$10$KDmWsbODf8lRtE8MRdsmu.krGlvaWjTtdvHjD8nE3o/pjLAMeETYu', 'fp-super-admin', 'ACTIVE'),
(2, 'Hospital Admin', '+1999888777', 'admin@cityhospital.com', '$2a$10$KDmWsbODf8lRtE8MRdsmu.krGlvaWjTtdvHjD8nE3o/pjLAMeETYu', 'fp-hosp-admin', 'ACTIVE'),
...
(4, 'John Customer', '+1111222333', 'john.doe@gmail.com', '$2a$10$KDmWsbODf8lRtE8MRdsmu.krGlvaWjTtdvHjD8nE3o/pjLAMeETYu', 'fp-cust-1', 'ACTIVE'),
(5, 'Jane Senior Citizen', '+1111222444', 'jane.senior@gmail.com', '$2a$10$KDmWsbODf8lRtE8MRdsmu.krGlvaWjTtdvHjD8nE3o/pjLAMeETYu', 'fp-cust-2', 'ACTIVE');
